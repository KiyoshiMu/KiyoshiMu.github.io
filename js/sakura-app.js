...
function add_copyright () {
  ...
  function setClipboardText (event) {
    ...
    var htmlData = '' + 'The copyright belongs to the author.<br>' + 'For commercial reprints, please contact the author for authorization. For non-commercial reprints, please indicate the source.<br>' + 'Author:' + mashiro_option.author_name + '<br>' + 'Link:' + window.location.href + '<br>' + 'Source:' + mashiro_option.site_name + '<br><br>' + window.getSelection().toString().replace(/\r\n/g, '<br>')
    var textData = '' + 'The copyright belongs to the author.\n' + 'For commercial reprints, please contact the author for authorization. For non-commercial reprints, please indicate the source.\n' + '' + mashiro_option.author_name + '\n' + 'Link:' + window.location.href + '\n' + 'Source:' + mashiro_option.site_name + '\n\n' + window.getSelection().toString().replace(/\r\n/g, '\n')
    if (event.clipboardData) {
      event.clipboardData.setData('text/html', htmlData)
      event.clipboardData.setData('text/plain', textData)
      addComment.createButterbar('Copied to clipboard successfully!', 1000)
